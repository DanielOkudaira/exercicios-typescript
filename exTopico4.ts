...
// Exemplo de uso:
const maiorNumero = encontrarMaiorElemento([10, 35, 50]);  // 50
const maiorPalavra = encontrarMaiorElemento(['gato', 'mamute', 'zebra']);  // 'zebra'

console.log(maiorNumero);  // Imprime 50
